...
var colpi_sparati: int = 0
var blocchi: int = 0           # zombie fermi senza nulla da mordere: sono incastri veri
var blocchi_dove := {}     # distingue "non ingaggiano mai" da "ingaggiano e non bastano"     # quante ne hai perse: dice se muoiono prima di servire   # morti all'alba invece che ammazzati: dice se le difese servono
var finita := false
